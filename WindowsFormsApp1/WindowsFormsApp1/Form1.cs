...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            Rectangle rect3 = new Rectangle(50, 380, 300, 80);
            Rectangle rect4 = new Rectangle(270, 50, 300, 80);

            LinearGradientBrush linearGradientBrush =
                new LinearGradientBrush(rect1, Color.Red, Color.Green, 0.0f, true);
            HatchBrush hatchBrush = new HatchBrush(HatchStyle.Cross, Color.Yellow);
            TextureBrush textureBrush = new TextureBrush(Image.FromFile("1.jpg"));
            ...
            Font font3 = new Font("Arial", 45, FontStyle.Bold);
